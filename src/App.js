                ...
                <AppBar position="static">
                    <Toolbar>
                        <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}>
                            KnapSack Problem Website solver ,  <b>By Metidji Sid Ahmed & Gouaouri Mohamed Dhiaa Eddine</b>
                        </Typography>
                    </Toolbar>
                </AppBar>
            </Box>
            ...
            <hr/>
            {
                !resultatMode ? (
                    <div className="col-12 justify-content-center d-flex mb-3">
                        <Button disabled={W <= 0 || !objects.length} onClick={()=>setResultatMode(true)} style={ !(W <= 0 || !objects.length ) ?  {color : '#ffdd00' , borderColor : '#ffdd00'} : {}} variant="outlined" startIcon={<Calculate />}>
